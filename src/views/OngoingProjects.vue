                ...
                <div class="flex items-start justify-between mb-4">
                  <div>
                    <div class="flex items-center gap-3 mb-2">
                      ...
                      <span class="px-3 py-1 bg-yellow-100 text-yellow-800 rounded-full text-xs font-semibold inline-flex items-center gap-1">
                        <svg class="w-3.5 h-3.5 text-yellow-700" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
